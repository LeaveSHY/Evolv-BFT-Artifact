...
func TestEvolvbftAdaptiveRuntimeObserve(t *testing.T) {
...
func TestEvolvbftAdaptiveRuntimeRecordOrderedOutputPreservesMonotonicState(t *testing.T) {
	block := types.NewBlock(7, nil, []byte("payload"), 3, 1, 0, 7, nil, nil)
	rt := evolvbftAdaptiveRuntime{}
...
func TestEvolvbftAdaptiveRuntimeApply(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
	rt := evolvbftAdaptiveRuntime{
		engines: []*hotstuff.Engine{engine},
	}
...
func TestEvolvbftAdaptiveRuntimeObserveIncludesScenarioContext(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
	rt := evolvbftAdaptiveRuntime{
		nodeID:  0,
		engines: []*hotstuff.Engine{engine},
...
func TestEvolvbftAdaptiveRuntimeObserveUsesCommittedConfigForCurrentAndDiscoveryForHighestKnown(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
	memberMgr := membership.NewMembershipManager(engine.GetCurrentValidatorSet().Validators)
...
func TestEvolvbftAdaptiveRuntimeObserveToleratesMissingHydraSubcomponents(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
	memberMgr := membership.NewMembershipManager(engine.GetCurrentValidatorSet().Validators)
	validators := make(map[uint64]*hydra.Validator, len(engine.GetCurrentValidatorSet().Validators))
	for id, v := range engine.GetCurrentValidatorSet().Validators {
...
func TestEvolvbftAdaptiveRuntimeObserveExportsAgentObservations(t *testing.T) {
...
func TestEvolvbftAdaptiveRuntimeApplyRoutesPerAgentActions(t *testing.T) {
	engine0 := buildAdaptiveEngineForTest(t)
	engine1 := hotstuff.NewEngineWithInstanceAndOptions(
		0,
		&types.Keypair{PublicKey: engine0.GetCurrentValidatorSet().Validators[0].PublicKey, PrivateKey: nil},
...
func TestEvolvbftAdaptiveRuntimeApplySubmitsSFACRemoteEvictIntent(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
	memberMgr := membership.NewMembershipManager(engine.GetCurrentValidatorSet().Validators)
...
func TestEvolvbftAdaptiveRuntimeApplyRollsBackHydraPendingJoinWhenTxEnqueueFails(t *testing.T) {
	validators := map[uint64]*types.Validator{
...
func TestEvolvbftAdaptiveRuntimeApplyRollsBackHydraPendingJoinWhenEngineMissing(t *testing.T) {
	validators := map[uint64]*types.Validator{
		0: {ID: 0, PublicKey: []byte("v0"), Power: 1, IsActive: true},
		1: {ID: 1, PublicKey: []byte("v1"), Power: 1, IsActive: true},
		2: {ID: 2, PublicKey: []byte("v2"), Power: 1, IsActive: true},
...
func TestEvolvbftAdaptiveRuntimeApplyRollsBackHydraPendingLeaveWhenEngineMissing(t *testing.T) {
	validators := map[uint64]*types.Validator{
		0: {ID: 0, PublicKey: []byte("v0"), Power: 1, IsActive: true},
		1: {ID: 1, PublicKey: []byte("v1"), Power: 1, IsActive: true},
		2: {ID: 2, PublicKey: []byte("v2"), Power: 1, IsActive: true},
...
func TestEvolvbftAdaptiveRuntimeApplyDoesNotRequestDiscoveryWhenJoinFails(t *testing.T) {
	validators := map[uint64]*types.Validator{
		0: {ID: 0, PublicKey: []byte("v0"), Power: 1, IsActive: true},
		1: {ID: 1, PublicKey: []byte("v1"), Power: 1, IsActive: true},
		2: {ID: 2, PublicKey: []byte("v2"), Power: 1, IsActive: true},
