...
func TestEvolvbftAdaptiveRuntimeObserveIncludesTrustSnapshots(t *testing.T) {
...
func TestEvolvbftAdaptiveRuntimeObserveTrustSnapshotsStayEmptyWithoutSignals(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
	rt := evolvbftAdaptiveRuntime{
		nodeID:  0,
		engines: []*hotstuff.Engine{engine},
...
func TestEvolvbftAdaptiveRuntimeObserveTrustSnapshotsTreatNilBlocksAsFailureSignals(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
...
func TestEvolvbftAdaptiveRuntimeObserveTrustSnapshotsDoNotReplaceTimingFields(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
...
func TestEvolvbftAdaptiveRuntimeObserveTrustSnapshotsAreSortedByNodeID(t *testing.T) {
	engine := buildAdaptiveEngineForTest(t)
...
func TestEstimateFaults_NilEstimatorReturnsZero(t *testing.T) {
	rt := &evolvbftAdaptiveRuntime{trustEst: nil}
...
func TestEstimateFaults_CountsHighProbabilityNodes(t *testing.T) {
	...
	rt := &evolvbftAdaptiveRuntime{trustEst: est}
	valSet := types.NewValidatorSet(1, map[uint64]*types.Validator{
		1: {ID: 1, Power: 1, IsActive: true},
		2: {ID: 2, Power: 1, IsActive: true},
...
func TestEstimateFaults_FusesWithAggregator(t *testing.T) {
	...
	rt := &evolvbftAdaptiveRuntime{trustEst: est, trustAgg: agg}
	valSet := types.NewValidatorSet(1, map[uint64]*types.Validator{
		1: {ID: 1, Power: 1, IsActive: true},
		2: {ID: 2, Power: 1, IsActive: true},
		3: {ID: 3, Power: 1, IsActive: true},
...
func TestEstimateFaults_AggregatorNilFallsBackToLocal(t *testing.T) {
	...
	rt := &evolvbftAdaptiveRuntime{trustEst: est, trustAgg: nil}
	valSet := types.NewValidatorSet(1, map[uint64]*types.Validator{
		1: {ID: 1, Power: 1, IsActive: true},
		2: {ID: 2, Power: 1, IsActive: true},
		3: {ID: 3, Power: 1, IsActive: true},
