...
func NewEngine(
	...
	return NewEngineWithInstanceAndOptions(nodeID, keypair, initialValSet, net, store, 0, 1, "evolvbft-consensus", nil, DefaultEngineOptions())
}
...
// transaction injection is wired explicitly by cmd/evolvbft so engine attachment
